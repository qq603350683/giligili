...
type UserPlan struct {
	...
	UID int `json:"u_id" gorm:"column:i_id; type:int(10) unsigned; not null; default:0; index:idx_u_id; comment:'用户ID 来自 users 表的 u_id'"`
	Detail UserPlanDetail `json:"detail" gorm:"column:detail; type: text; not null; comment:'飞机详情'"`
...
// 被动技能
type Skill struct {
	SID int `json:"s_id" comment:"暂时不要"`
	Width int `json:"w" comment:"宽度"`
	Height int `json:"h" comment:"高度"`
	Position int8 `json:"p" comment:"位置"`
	Angle int8 `json:"a" comment:"角度"`
