...
func UserPlanUpgradeBulletSpeed(params Params) {
	id := 0
	up_id := 0
	index := -1
	bullet := model.Bullet{}
	...
	// 已达到最高强化级别
	if user_plan.Detail.Bullets[index].MaxSpeed <= user_plan.Detail.Bullets[index].Speed {
